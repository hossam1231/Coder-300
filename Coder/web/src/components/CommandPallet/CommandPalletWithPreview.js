...
export default function CommandPalletWithPreview({
  open,
  setOpen,
  title,
  commandPalletValue,
  ...
  React.useEffect(() => {
    if (commandPalletValue) {
      console.log(`%c 🧗‍♀️:  ${commandPalletValue.iconUrl}`)
    }
  }, [commandPalletValue])
                ...
                <>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      type="button"
                      className="absolute top-3.5 right-4  rounded-full border border-transparent bg-indigo-600  text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                    >
